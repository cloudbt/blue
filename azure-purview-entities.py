...
# Define the base qualified name
base_qualified_name = f"mssql://your-server.database.windows.net/your-database/your-schema/M_Approver"
...
entities = [
    {
        ...
        "attributes": {
            "name": "M_Approver",
            "qualifiedName": f"{base_qualified_name}#{collection_id}",
    ...
    },
    {
        ...
        "attributes": {
            "name": "RowVersion",
            "qualifiedName": f"{base_qualified_name}#RowVersion#{collection_id}",
            "data_type": "timestamp",
    ...
    },
    {
        ...
        "attributes": {
            "name": "ID",
            "qualifiedName": f"{base_qualified_name}#ID#{collection_id}",
            "data_type": "varchar",
            "length": 100,
    ...
    },
    {
        ...
        "attributes": {
            "name": "Name",
            "qualifiedName": f"{base_qualified_name}#Name#{collection_id}",
            "data_type": "nvarchar",
            "length": 30,
